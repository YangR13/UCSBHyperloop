...
#define GATHER_DATA_ACTIVE      	(PHOTO_ELECTRIC_ACTIVE || RANGING_SENSORS_ACTIVE || SMOOSHED_ONE_ACTIVE || SMOOSHED_TWO_ACTIVE || MOTOR_BOARD_I2C_ACTIVE || CONTACT_SENSOR_ACTIVE)
