...
#define RANGING_SENSORS_ACTIVE		0 && MOTOR_BOARD_I2C_ACTIVE
...
#define PWR_DST_BMS_ACTIVE          0 // You should only turn this off if you're working with a bare board and not the whole pod.
